                    ...
                    <div class="col-md-6">
                        ...
                        <div class="m-account--content-w" data-bg-img="{{ url('vendor/dadmin/assets/img/account/content-bg.jpg') }}">
                            <div class="m-account--content">
                                ...
                                <a href="{{ route('user.login') }}" class="btn btn-rounded">Acessar</a>
                            </div>
                        </div>
                        <!-- Login Content End -->
                    </div>
                        ...
                        <div class="m-account--form-w">
                            <div class="m-account--form">
                                ...
                                <form action="{{ route('user.password.email') }}" method="POST">
                                    <label class="m-account--title text-loginarea" style="text-transform: inherit;font-weight: lighter;">
                                    {{ __('Redefinir Senha') }}
                                    </label>
                                    @csrf
                                    ...
                                    <div class="m-account--actions">
                                        <p>     
                                        Não lembra seu e-mail? <a href="mailto:erickfirmo.dev?subject=[AUTOMAÇÃO DE DISPAROS] Esqueci meu e-mail" class="pl-1" style="color:#e16123;">Entre em contato com o suporte.</a>
                                        </p>
                                    </div>
                                    <div class="m-account--actions">
                                            <button type="submit" class="btn btn-block btn-rounded btn-warning">
                                            {{ __('Redefinir Senha') }}
                                            </button>
                                    </div>
