            ...
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        ...
                        <form action="{{ route('empresas.destroy', $empresa->id) }}" method="POST" class="remove-form" style="float:right">
                            {{method_field('DELETE')}}
                    ...
                    <div class="panel-content">
                        ...
                        <form action="{{ route('empresas.update', $empresa->id) }}" method="POST" class="show-onload d-none">
                            @csrf
                            {{ method_field('PUT') }}
                            <!-- Form Group Start -->
                            ...
                            <div class="row">
                                <div class="col-lg-10 offset-lg-2">
                                    ...
                                    <a href="{{ route('empresas.index') }}"><button type="button" class="btn btn-sm btn-rounded btn-outline-secondary">Voltar</button></a>
                                </div>
                            </div>
