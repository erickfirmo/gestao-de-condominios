                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('moradores.index') }}">Visitantes</a></li>
                ...
                <div class="panel">
                    ...
                    <div class="records--header">
                        ...
                        <div class="title fa-university">
                            ...
                            <a href="{{ route('moradores.create') }}" class="btn btn-sm btn-outline-info">Adicionar Visitante</a>
