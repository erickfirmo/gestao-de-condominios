            ...
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Editar Vaga</h3>
                        <form action="{{ route('vagas.destroy', $vaga->id) }}" method="POST" class="remove-form" style="float:right">
                            {{method_field('DELETE')}}
                            <a href="#"><button class="btn btn-rounded btn-danger">Deletar Vaga</button></a>
                        </form>
                    </div>
                    ...
                    <div class="panel-content">
                        ...
                        <form action="{{ route('vagas.update', $vaga->id) }}" method="POST" class="show-onload d-none">
                            @csrf
                            {{ method_field('PUT') }}
