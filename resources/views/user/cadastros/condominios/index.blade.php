                ...
                <div class="panel">
                    ...
                    <div class="records--header">
                        ...
                        <div class="title fa-university">
                            ...
                            <a href="{{ route('condominios.create') }}" class="btn btn-sm btn-outline-info">Adicionar Condomínio</a>
                                ...
                                <tr id="{{ 'empresa-'.$condominio->id }}">
                                    ...
                                    <td>
                                        <button class="d-inline mr-2 btn-action">
                                            <a href="{{ route('condominios.edit', $condominio->id ) }}" class="btn-link"><i class="fa fa-pencil-alt"></i></a>
                                        </button>

                                        

                                        <form action="{{ route('condominios.destroy', $condominio->id) }}" method="POST" class="remove-form">
                                            @csrf
                                            {{method_field('DELETE')}}
