        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('condominios.index') }}">Condomínios</a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        ...
                        <form action="{{ route('condominios.destroy', $condominio->id) }}" method="POST" class="remove-form" style="float:right">
                            {{method_field('DELETE')}}
                    ...
                    <div class="panel-content">
                        ...
                        <form action="{{ route('condominios.update', $condominio->id) }}" method="POST" class="show-onload d-none">
                            @csrf
                            {{ method_field('PUT') }}
                            <!-- Form Group Start -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <span class="form-text text-error"></span>
                                    <input type="text" name="uf_id" class="form-control" id="uf_id" maxlenght="2" value="{{ $condominio->uf()->uf }}">
                                </div>
                            </div>
                            <!-- Form Group End -->
                            ...
                            <div class="row">
                                <div class="col-lg-10 offset-lg-2">
                                    ...
                                    <a href="{{ route('condominios.index') }}"><button type="button" class="btn btn-sm btn-rounded btn-outline-secondary">Voltar</button></a>
                                </div>
                            </div>
