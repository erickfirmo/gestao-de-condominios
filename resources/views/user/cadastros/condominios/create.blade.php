            ...
            <div class="col-md-12">
                ...
                <div class="panel">
                    ...
                    <div class="panel-content">
                        ...
                        <form action="{{ route('condominios.store') }}" method="POST" class="show-onload d-none">
                            @csrf
                            <!-- Form Group Start -->
                            ...
                            <div class="row">
                                <div class="col-lg-10 offset-lg-2">
                                    ...
                                    <a href="{{ route('condominios.index') }}"><button type="button" class="btn btn-sm btn-rounded btn-outline-secondary">Cancelar</button></a>
                                </div>
                            </div>
