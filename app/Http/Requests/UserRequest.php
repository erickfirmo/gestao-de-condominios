            ...
            if($this->input('_method') == 'PUT' || $this->input('_method') == 'PATCH') {
                if(Auth::user()->id == $this->route('id')) {
                    return [
                        ...
                        'telefone_2' => 'nullable|min:10|max:11',
                        'cargo' => 'required|max:30|string',
                        'password' => 'nullable|min:6|max:40|string|confirmed',
                        'password_confirmation'=>'nullable|required_with:password|min:6|max:40|string',
